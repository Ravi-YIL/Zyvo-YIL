...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/PersonaInquirySDK2/Persona2.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/TwilioCommonLib/TwilioCommonLib.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/TwilioConversationsClient/TwilioConversationsClient.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/TwilioStateMachine/TwilioStateMachine.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/TwilioTwilsockLib/TwilioTwilsockLib.framework"
fi
